...
d$exe_solution <- ifelse(d$slides_title == "Rmarkdown",
                         "[report.Rmd](https://raw.githubusercontent.com/acobos/CDB_ed2/main/6_3_Rmarkdown_exe_1_solution.Rmd),  [slides.Rmd](6_3_Rmarkdown_exe_2_solution.Rmd)",
                         d$exe_solution)

d$exe_solution <- ifelse(d$slides_title == "More Rmarkdown",
                         "[.Rmd](6_4_more_Rmarkdown_exe_solution.Rmd)",
                         d$exe_solution)
