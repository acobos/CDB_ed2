...
## Computational reproducibility (lack of)
...
- [Ioannidis, Nature Genetics 2009](https://www.nature.com/articles/ng.295):
    ...
    > In 13/35 articles at least one value could not be reproduced despite author assistance. Incomplete specification of data processing and analysis can impede analytic reproducibility. 
...
- `tinytext`:  needed to create pdf documents, you should install it now.
