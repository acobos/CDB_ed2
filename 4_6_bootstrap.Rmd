...
The `erosive_esophagitis.xls`files contains data on a clinical trial comparing two treatments (A or B) for severe erosive esophagitis. The primary efficacy endpoint was the healing of all erosions as determined by endoscopy after eight weeks of therapy.
