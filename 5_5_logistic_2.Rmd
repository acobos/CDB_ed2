...
```{r}
d$pred <- predict(mod_si,  type = "response")
head(d[,-c(1,2)], 3)     # first 3 lines of d (subsetted to drop columns 1 and 2)
tail(d[,-c(1,2)], 3)     # last 3 lines of d (subsetted to drop columns 1 and 2)
```
